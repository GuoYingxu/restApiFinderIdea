...
//        this.toolWindowShown(ToolWindowManager.getInstance(project));
    ...
    public void toolWindowShown(@NotNull ToolWindow toolWindow) {
        ...
        if(toolWindow.getStripeTitle().equals("api")) {
            ...
            ((JList)toolWindow.getContentManager().findContent("api").getComponent().getComponent(0)).setListData(restApiModelList.toArray());
//            ((ApiListWindow) toolWindow).updateList(restApiModelList);
        }
    }
